...
public class EditTrainerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack = findViewById(R.id.btn_reset_trainer_back);
        btnReset = findViewById(R.id.btn_reset_trainer);
        spnEmail = findViewById(R.id.spinner_reset_trainer);

        db = FirebaseFirestore.getInstance();
        customProgressDialog = new CustomProgressDialog(EditTrainerActivity.this);
        sharedPreferencesManager = new SharedPreferencesManager(EditTrainerActivity.this);
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(spnEmail.getSelectedItem().toString().equals("Loading...")){
                    ...
                    new CustomAlertDialog().negativeDismissAlert(EditTrainerActivity.this, "Oops!", "Please fill out all the\nrequired inputs!", CFAlertDialog.CFAlertStyle.ALERT);
                }else{
                                                            ...
                                                            Thread thread = new Thread(new Runnable() {
                                                                ...
                                                                public void run() {
                                                                    try {
                                                                        ...
                                                                        startActivity(new Intent(EditTrainerActivity.this, SuccessEmailActivity.class));
                                                                        Animatoo.animateSlideLeft(EditTrainerActivity.this);
                                                                        customProgressDialog.dismissProgress();
...
//                                                    new CustomAlertDialog().negativeAlert(AddUserActivity.this, "Oops!", "Something went wrong.\nPlease try again later!","OK", CFAlertDialog.CFAlertStyle.ALERT);
                                                            ...
                                                            customProgressDialog.dismissProgress();
                                                            new CustomAlertDialog().negativeAlert(EditTrainerActivity.this, "Oops!", "Check Your Email Address & Please try again later!","OK", CFAlertDialog.CFAlertStyle.ALERT);
                                                            e.printStackTrace();
                                                        } catch (MessagingException e) {
                                                            customProgressDialog.dismissProgress();
                                                            new CustomAlertDialog().negativeAlert(EditTrainerActivity.this, "Oops!", "Something went wrong.\nPlease try again later!","OK", CFAlertDialog.CFAlertStyle.ALERT);
                                                            e.printStackTrace();
                                                        }catch (Exception e){
                                                            customProgressDialog.dismissProgress();
                                                            new CustomAlertDialog().negativeAlert(EditTrainerActivity.this, "Oops!", "Something went wrong.\nPlease try again later!","OK", CFAlertDialog.CFAlertStyle.ALERT);
                                        ...
                                        customProgressDialog.dismissProgress();
                                        new CustomAlertDialog().negativeDismissAlert(EditTrainerActivity.this, "Oops!", "There is no any account related to this Email!", CFAlertDialog.CFAlertStyle.ALERT);
                                    }
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    customProgressDialog.dismissProgress();
                                    new CustomAlertDialog().negativeDismissAlert(EditTrainerActivity.this, "Oops!", "Something went wrong\nPlease try again later!", CFAlertDialog.CFAlertStyle.ALERT);
                                }
                            });
                }
            }
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(EditTrainerActivity.this, android.R.layout.simple_spinner_dropdown_item, arraylist);
